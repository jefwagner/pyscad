PySCAD: Python based OpenSCAD inspired solid modeling system
============================================================

.. warning::
    This project is under active development and does not work.

The goal of this project is make an OpenSCAD like package for doing 3-d solid
design in python.
...
manipulated with affine transformations such as translations, rotations, and
scalings. A pyscad object will be represented internally in python as a tree,
where every internal node is a operator and every leaf node is a basic object
and every node has a list of transformations applied.
